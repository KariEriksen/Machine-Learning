...
The bootstrap is a resampling method where we draw sample values with replacement from a datasample of some experiment ex. For each time we draw new samples from the 
